        ...
        {   
            ...
            { 
                ...
                <div class="col-2 col-sm-1 col-md-1">
                    <img src="${friendPhoto}" alt="" class="chat-pic rounded-circle" />
                </div>
                <div class="col-6 col-sm-7 col-md-7">
                    <p class="receive">
                    ${chat.msg}
                    <span class="time float-right" title="${dateTime[0]}">${dateTime}</span>
                    </p>
                </div>
            </div>`;
            ...
            else
            {
                ...
                <div class="col-2 col-sm-1 col-md-1">
                    <img src="${firebase.auth().currentUser.photoURL}" alt="" class="chat-pic rounded-circle"/>
                </div>
            </div>`;
...
function SendMessage()
{
    ...
    firebase.database().ref('chatMessages').child(chatKey).push(chatMessage, function(error){
        if(error) alert(error);
            ...
            <div class="col-2 col-sm-1 col-md-1">
                <img src="${firebase.auth().currentUser.photoURL}" alt="" class="chat-pic">
            </div>
        </div>`;
...
function populateFriendList()
{
    ...
    <span class="spinner-border text-primary mt-5" style="width:7em; height:7em"></span>
    ...
    if (user)
    {
        ...
        db.on('value', function (users)
        {
            ...
            if (flag === false)
            {
                ...
                document.getElementById('imgProfile').title=firebase.auth().currentUser.display;
        ...
        document.getElementById('imgProfile').src='icon6.PNG';
